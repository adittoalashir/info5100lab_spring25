...
public void enableAll(){
    ...
    this.hobbiesTextArea1.setEnabled(true);
}
...
public void disableAll(){
    ...
    private void initComponents() {
        ...
        hobbiesTextArea1.setEnabled(false);
        ...
        userjTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "first_name", "last_name", "college", "age", "hobbies"
            }
        ) {
...
// TODO add your handling code here:
// 1. which user to delete?
// find the row that the user has clicked on
...
try {
    // find the user at that index
    this.userObject = this.users.get(selectedRowIndex);
    // set the values in the text boxes, comboboxes, ...
    setAllFields();
    // make them all enabled
    enableAll();
} catch (Exception e) {
    // Handle exception
}
...
updatedUser.setHobby(this.hobbiesTextArea1.getText());

// 2. call the update user method from the database connector
try {
